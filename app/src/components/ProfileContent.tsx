          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><Label htmlFor="traderType">Trading Type</Label><Select value={traderType} onValueChange={setTraderType} disabled={loading || uploading}><SelectTrigger id="traderType"><SelectValue placeholder="Select trading type" /></SelectTrigger><SelectContent><SelectItem value="Day Trader">Day Trader</SelectItem><SelectItem value="Intra Day Trader">Intra Day Trader</SelectItem><SelectItem value="Swing Trader">Swing Trader</SelectItem><SelectItem value="Position Trader">Position Trader</SelectItem><SelectItem value="Scalper">Scalper</SelectItem><SelectItem value="Investor">Investor</SelectItem></SelectContent></Select></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
