...
import { Loader2, Check, ChevronLeft, ChevronRight, TrendingUp, Clock, Calendar, AlertTriangle, Info, Plus, X, User, Maximize2, Minimize2, X as LucideX, CheckCircle } from "lucide-react";
...
const TopDownAnalysisDialog = ({ isOpen, onClose }: TopDownAnalysisDialogProps) => {
  ...
  const getGenericTimeframeQuestions = (timeframe: TimeframeType) => {
    const timeframeLabel = allTimeframes.find(t => t.value === timeframe)?.label.replace(' Analysis', '') || timeframe;
    
    // Base questions for all timeframes
    const baseQuestions = [
      {
        id: `${timeframe.toLowerCase()}_trend`,
        timeframe: timeframe as TimeframeType,
        question_text: `Current ${timeframeLabel} Trend`,
      ...
      {
        id: `${timeframe.toLowerCase()}_support_resistance`,
        timeframe: timeframe as TimeframeType,
        question_text: "Key Support / Resistance Levels",
      ...
      {
        id: `${timeframe.toLowerCase()}_cycle_pressure`,
        timeframe: timeframe as TimeframeType,
      ...
      {
        id: `${timeframe.toLowerCase()}_patterns`,
        timeframe: timeframe as TimeframeType,
      ...
      {
        id: `${timeframe.toLowerCase()}_analysis`,
        timeframe: timeframe as TimeframeType,
    ...
    // Additional timeframe-specific questions
    ...
    switch (timeframe) {
      case 'MN1':
        additionalQuestions = [
          {
            id: `${timeframe.toLowerCase()}_market_structure`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Market Structure (Higher Highs/Lower Lows)',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Higher Highs & Higher Lows', 'Lower Highs & Lower Lows', 'Mixed Structure', 'Consolidation'],
            required: false,
            order_index: 6,
            created_at: new Date().toISOString(),
            is_active: true
          ...
          {
            id: `${timeframe.toLowerCase()}_major_levels`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Major Psychological Levels',
            question_type: 'TEXT' as any,
            required: false,
            order_index: 7,
            created_at: new Date().toISOString(),
          ...
          {
            id: `${timeframe.toLowerCase()}_fundamental_context`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Fundamental Context Notes',
            question_type: 'TEXT' as any,
            required: false,
            order_index: 8,
            created_at: new Date().toISOString(),
      ...
      case 'W1':
        additionalQuestions = [
          {
            id: `${timeframe.toLowerCase()}_weekly_momentum`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Weekly Momentum Direction',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Strong Bullish', 'Moderate Bullish', 'Neutral', 'Moderate Bearish', 'Strong Bearish'],
            required: false,
            order_index: 6,
            created_at: new Date().toISOString(),
            is_active: true
          ...
          {
            id: `${timeframe.toLowerCase()}_key_swing_levels`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Key Swing High/Low Levels',
            question_type: 'TEXT' as any,
            required: false,
            order_index: 7,
            created_at: new Date().toISOString(),
          ...
          {
            id: `${timeframe.toLowerCase()}_weekly_volatility`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Weekly Volatility Assessment',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Low Volatility', 'Normal Volatility', 'High Volatility', 'Extreme Volatility'],
            required: false,
            order_index: 8,
            created_at: new Date().toISOString(),
            is_active: true
      ...
      case 'H8':
        additionalQuestions = [
          {
            id: `${timeframe.toLowerCase()}_session_momentum`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Session Momentum (London/NY)',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['London Bullish', 'London Bearish', 'NY Bullish', 'NY Bearish', 'Mixed Sessions'],
            required: false,
            order_index: 6,
            created_at: new Date().toISOString(),
            is_active: true
          ...
          {
            id: `${timeframe.toLowerCase()}_intraday_levels`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Intraday Key Levels',
            question_type: 'TEXT' as any,
            required: false,
            order_index: 7,
            created_at: new Date().toISOString(),
          ...
          {
            id: `${timeframe.toLowerCase()}_volume_profile`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Volume Profile Assessment',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['High Volume Areas', 'Low Volume Areas', 'Volume Increasing', 'Volume Decreasing', 'Normal Volume'],
            required: false,
            order_index: 8,
            created_at: new Date().toISOString(),
            is_active: true
      ...
      case 'H4':
        additionalQuestions = [
          {
            id: `${timeframe.toLowerCase()}_trend_strength`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Trend Strength Assessment',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Strong Trend', 'Moderate Trend', 'Weak Trend', 'No Clear Trend'],
            required: false,
            order_index: 6,
            created_at: new Date().toISOString(),
            is_active: true
          ...
          {
            id: `${timeframe.toLowerCase()}_breakout_levels`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Potential Breakout Levels',
            question_type: 'TEXT' as any,
            required: false,
            order_index: 7,
            created_at: new Date().toISOString(),
          ...
          {
            id: `${timeframe.toLowerCase()}_momentum_divergence`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Momentum Divergence',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Bullish Divergence', 'Bearish Divergence', 'No Divergence', 'Hidden Bullish', 'Hidden Bearish'],
            required: false,
            order_index: 8,
            created_at: new Date().toISOString(),
            is_active: true
      ...
      case 'H2':
        additionalQuestions = [
          {
            id: `${timeframe.toLowerCase()}_short_term_momentum`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Short-term Momentum',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Accelerating Bullish', 'Decelerating Bullish', 'Accelerating Bearish', 'Decelerating Bearish', 'Sideways'],
            required: false,
            order_index: 6,
            created_at: new Date().toISOString(),
            is_active: true
          ...
          {
            id: `${timeframe.toLowerCase()}_immediate_levels`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Immediate Support/Resistance',
            question_type: 'TEXT' as any,
            required: false,
            order_index: 7,
            created_at: new Date().toISOString(),
          ...
          {
            id: `${timeframe.toLowerCase()}_volatility_expansion`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Volatility Expansion/Contraction',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Expanding', 'Contracting', 'Stable', 'Spiking'],
            required: false,
            order_index: 8,
            created_at: new Date().toISOString(),
            is_active: true
      ...
      case 'M30':
        additionalQuestions = [
          {
            id: `${timeframe.toLowerCase()}_micro_trend`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Micro Trend Direction',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Strong Up', 'Weak Up', 'Sideways', 'Weak Down', 'Strong Down'],
            required: false,
            order_index: 6,
            created_at: new Date().toISOString(),
            is_active: true
          ...
          {
            id: `${timeframe.toLowerCase()}_scalp_levels`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Scalping Entry/Exit Levels',
            question_type: 'TEXT' as any,
            required: false,
            order_index: 7,
            created_at: new Date().toISOString(),
          ...
          {
            id: `${timeframe.toLowerCase()}_order_flow`,
            timeframe: timeframe as TimeframeType,
            question_text: 'Order Flow Assessment',
            question_type: 'MULTIPLE_CHOICE' as any,
            options: ['Buying Pressure', 'Selling Pressure', 'Balanced', 'Large Orders', 'Small Orders'],
            required: false,
            order_index: 8,
            created_at: new Date().toISOString(),
            is_active: true
            ...
            {question.options?.map((option) => {
              ...
              if (option.includes('Blue Below Red') || option.includes('Blue Above Red')) {
                colorClass = 'text-slate-800 font-medium';
                  ...
                  option.includes('At Expected Bottom') || option.includes('Long Drive Zone') || 
                  option.includes('Long Exhaustion Zone')) {
                colorClass = 'text-green-700 font-medium';
                         ...
                         option.includes('At Expected Top Sideways') || option.includes('Short Drive Zone') || 
                         option.includes('Short Exhaustion Zone') || option.includes('Lower Lows')) {
                colorClass = 'text-red-700 font-medium';
              } else if (option.includes('Medium')) {
                colorClass = 'text-orange-700 font-medium';
              } else if (option.includes('High') && !option.includes('Higher Highs')) {
                colorClass = 'text-red-700 font-medium';
              } else if (option.includes('Higher Highs')) {
                colorClass = 'text-green-700 font-medium';
              } else if (option.includes('Sideways') || option.includes('Parallel') || option.includes('Converging') || 
                         option.includes('Diverging') || option.includes('Neutral') || option.includes('Mixed') ||
                         option.includes('Consolidation') || option.includes('Choppy') || option.includes('Balanced')) {
